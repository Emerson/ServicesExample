...
describe('User', function() {
  ...
  it('creates a user', function(done) {
    var attributes = {email: 'create@create.com', first_name: 'Create', last_name: 'Test', password: 'ted123'}
  ...
  it('returns validation errors', function(done) {
    Model.create({}, function(err, results) {
      assert(err)
      assert(err.hasOwnProperty('email'))
      assert(err.hasOwnProperty('first_name'))
      assert(err.hasOwnProperty('last_name'))
    })
  })
